@echo off
rem OpenSkyrim: walk from the Alftand entrance down to Blackreach, no loading screens.
...
start "" "target\release\engine.exe" --assets "%OPENSKYRIM_CONVERTED_DIR%" --demo alftand --walk
