...
struct TerrainSettings {
    ...
    // packed vertex attributes below are the only source (the synthetic fixtures).
...
fn fragment(in: VertexOutput, @builtin(front_facing) is_front: bool) -> FragmentOutput {
    ...
    // The packed-tangent carrier, for materials with no weight field (the synthetic fixtures).
