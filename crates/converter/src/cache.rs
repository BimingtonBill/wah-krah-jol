...
pub const CONVERTER_SCHEMA_VERSION: u32 = 24;
...
impl ConversionManifest {
    pub fn load(path: &Path) -> Result<Self> {
        ...
        if matches!(manifest.schema_version, 12..=23) && CONVERTER_SCHEMA_VERSION == 24 {
            // Schemas 13-24 change only NIF publication (15: vertex alpha is not blend, blend
            ...
            // kept as opacity only on blended shapes) and the world
